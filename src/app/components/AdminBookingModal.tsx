                          ...
                          <button
                            ...
                            className={`flex flex-col items-center justify-center rounded-xl border px-3 py-2 text-xs font-semibold transition-all ${
                              isActive
                                ...
                                : `border-[#1f2a44] bg-[#101827] ${isWeekend ? 'text-rose-200/80' : 'text-white/80'} hover:border-[#ee2b7c]/60`
                            } ${isToday && !isActive ? 'ring-1 ring-[#ee2b7c]/40' : ''}`}
                          >
                            <span className={`text-[10px] uppercase tracking-wide ${isWeekend ? 'text-rose-200/60' : 'text-white/60'}`}>
                              {weekDays[(cell.getDay() + 6) % 7]}
                            </span>
                            <span className={`text-sm font-bold ${isToday && !isActive ? 'text-[#ee2b7c]' : ''}`}>
