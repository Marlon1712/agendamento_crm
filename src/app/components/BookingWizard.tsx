                            ...
                            <div className="flex justify-center">
                                <Calendar
                                    ...
                                    blockedDates={(calendarStatus?.blockedBlocks || [])
                                        ...
                                        .map((b: any) => b.blocked_date ? b.blocked_date.split('T')[0] : '')
                                        .filter((d: string) => d) // Remove empty strings
                                    }
                                />
                            </div>
                    ...
                    {step === 2 && (
                        <div className="animate-fade-in">
                            ...
                            <p className="text-center text-gray-500 mb-4 text-sm">
                                Para <strong>{selectedProcedure?.name}</strong> em {date ? date.split('-').reverse().join('/') : ''}
                            </p>
                    ...
                    {step === 3 && (
                        <div className="animate-fade-in">
                            ...
                            <div className="mt-6 bg-fuchsia-50 p-4 rounded-xl border border-fuchsia-100 text-center">
                                ...
                                <p className="text-gray-600 mb-2">{date ? date.split('-').reverse().join('/') : ''} às {time}</p>
